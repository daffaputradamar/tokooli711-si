...
class Suplier extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($cari <> '') {
            $config['base_url'] = base_url() . 'suplier?cari=' . urlencode($cari);
            $config['first_url'] = base_url() . 'suplier?cari=' . urlencode($cari);
        } else {
            $config['base_url'] = base_url() . 'suplier';
            $config['first_url'] = base_url() . 'suplier';
        }
