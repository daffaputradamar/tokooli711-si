    ...
    public function insert()
    {
        ...
        if ($this->input->post('submitlist') <> "") {
            if ($this->input->post('jumlah') <> "") {
                ...
                $cek = isset($_SESSION[$kode_user . 'detailbarang'][$this->input->post('kode_barang')]);
            ...
            if ($this->form_validation->run() == false) {
                ...
                if ($this->uri->segment(3) <> "" and $this->uri->segment(3) == 1) {
                    if ($this->input->post('cetak') == "on") {
                        ...
                        // echo '<meta http-equiv="refresh" content="0;url=http://localhost/solokuro/index.php/home">';
                        redirect(site_url('home'), 'refresh');
                    } else {
                        redirect(site_url('home'), 'refresh');
                    }
