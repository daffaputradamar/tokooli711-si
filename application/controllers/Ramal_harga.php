...
class Ramal_harga extends CI_Controller
{
    ...
    function index(){
        ...
        if ($cari <> '') {
            $config['base_url'] = base_url() . 'ramal_harga?cari=' . urlencode($cari);
            $config['first_url'] = base_url() . 'ramal_harga?cari=' . urlencode($cari);
        } else {
            $config['base_url'] = base_url() . 'ramal_harga';
            $config['first_url'] = base_url() . 'ramal_harga';
        }
