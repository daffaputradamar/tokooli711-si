...
class Ramal extends CI_Controller
{
    ...
    function index(){
        ...
        if ($cari <> '') {
            $config['base_url'] = base_url() . 'ramal?cari=' . urlencode($cari);
            $config['first_url'] = base_url() . 'ramal?cari=' . urlencode($cari);
        } else {
            $config['base_url'] = base_url() . 'ramal';
            $config['first_url'] = base_url() . 'ramal';
        }
