...
class Merk extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($cari <> '') {
            $config['base_url'] = base_url() . 'merk?cari=' . urlencode($cari);
            $config['first_url'] = base_url() . 'merk?cari=' . urlencode($cari);
        } else {
            $config['base_url'] = base_url() . 'merk';
            $config['first_url'] = base_url() . 'merk';
        }
