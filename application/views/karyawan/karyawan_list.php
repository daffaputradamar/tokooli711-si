				...
				?>
					<tr>
						...
						<td style="text-align:center">
							...
							$class = '';
							$txt = '';
							if($karyawan->isblocked) {
								$class = 'class="btn btn-warning" style="margin-right:0"';
								$txt = 'Reset Percobaan';
							} else {
								$class = 'class="btn btn-secondary disabled" style="margin-right:0"';
								$txt = '-';
							}
							
							echo anchor(site_url('karyawan/resetpercobaan/' . $karyawan->kode_karyawan), $txt, $class);
							?>
						</td>
