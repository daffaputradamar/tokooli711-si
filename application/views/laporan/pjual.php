...
<div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <a href="<?=base_url()?>index.php/laporan/pjualprint/<?=$this->uri->segment(3)?>/<?=$this->uri->segment(4)?>" target='_blank' class="btn btn-primary" >
...
<table class="table table-bordered table-hover table-striped">
<tr>
	<td>Total Transaksi : Rp. <?= $this->CodeGenerator->rp($hjual + $hgaji); ?></td>
</tr>
<!-- <tr>
...
<tr>
	<td>Bea Lain - lain : Rp. <?= $this->CodeGenerator->rp($hgaji); ?></td>
</tr>
<tr>
