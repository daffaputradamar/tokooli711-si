        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="form-group col-lg-4">
                                ...
                                <input type="text" class="form-control" name="kode_jual" id="kode_jual"
                                    placeholder="Kode Jual" value="<?php echo $kode_jual; ?>" readonly />
                            </div>
                            <div class="form-group col-lg-4">
                                ...
                                <input type="text" class="form-control" name="tanggal_jual" id="tanggal_jual"
                                    placeholder="Tanggal Jual" value="<?php echo $tanggal_jual; ?>" />
                            </div>
                            <div class="form-group col-lg-4">
                                ...
                                <input type="text" class="form-control" name="kode_admin" id="kode_admin"
                                    placeholder="Kode Admin" value="<?php echo $kode_admin; ?>" readonly />
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-5 col-lg-8">
                                ...
                                <select name="kode_barang" class="form-control selectpicker" data-live-search="true"
                                    ...
                                    ?>
                                    <option value="<?= $komp->kode_barang ?>" data-merk="<?= $komp->merk ?>"
                            ...
                            <div id="merk-drum" class="d-none">
                                <div class="form-group col-md-2 col-lg-2">
                                    <label for=>Rupiah<?php echo form_error('rupiah') ?></label>
                        ...
                        <table class="table table-bordered table-hover table-striped">
                            ...
                            <tr>
                                ...
                                <td>Rp. <?= $this->CodeGenerator->rp($penjualandetail['subtotal']) ?>
                                </td>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="form-group col-md-4">
                                <label for=>Kasir <?php echo form_error('kode_karyawan') ?></label>
                                ...
                                <select name="kode_karyawan" class="form-control" placeholder="kode_karyawan" readonly>
                                    ...
                                    ?>
                                    <option value="<?= $karyawan->kode_karyawan ?>" selected>
                                        <?= $karyawan->nama_karyawan ?>
                                    </option>
                                    <?php
                                    } else {
                                    ?>
                                    <option value="<?= $admin->kode_admin ?>" selected><?= $admin->nama_admin ?>
                                    </option>
                                    <?php
                                    }
                                    ?>
                            ...
                            <div class="form-group col-md-4">
                                <label for=>Bea Lain-lain <?php echo form_error('ongkos_karyawan') ?></label>
                            ...
                            <div class="form-group col-md-4">
                                <label for=>Nomor Polisi <?php echo form_error('nomor_polisi') ?></label>
                            ...
                            <div class="form-group col-md-4">
                                <label for=>Kilo Meter Kendaraan <?php echo form_error('km_kendaraan') ?></label>
                ...
                <div class="text-center">
                    <a href="<?php echo site_url('penjualan') ?>" class="btn btn-lg"
                        style="margin-right:30px;">Cancel</a>
...
<div class="row margin-top-10 collapse" id="demo">
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
        <div class="dashboard-stat2">
            <div class="display">
                <div class="number">
                    <h4 class="font-red-haze">Rp. <?= $this->CodeGenerator->rp($semua + $byTgl); ?>
                    </h4>
    ...
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
        <div class="dashboard-stat2">
            <div class="display">
                <div class="number">
                    <h4 class="font-red-haze">Rp. <?= $this->CodeGenerator->rp($byTgl); ?>
                    </h4>
        ...
        <div class="dashboard-stat2">
            <div class="display">
                <div class="number">
                    ...
                    <h4 class="font-green-sharp">Total Rp. <?= $this->CodeGenerator->rp($kasir1['total']); ?>
                    </h4>
                    <h4 class="font-red-haze">Penjualan Rp. <?= $this->CodeGenerator->rp($kasir1['transaksi']); ?>
                    </h4>
                    <h4>Bea Rp. <?= $this->CodeGenerator->rp($kasir1['bea']); ?>
                    </h4>
                </div>
                <div class="icon">
                    <i class="icon-like"></i>
        ...
        <div class="dashboard-stat2">
            <div class="display">
                <div class="number">
                    ...
                    <h4 class="font-green-sharp">Total Rp. <?= $this->CodeGenerator->rp($kasir2['total']); ?>
                    </h4>
                    <h4 class="font-red-haze">Penjualan Rp. <?= $this->CodeGenerator->rp($kasir2['transaksi']); ?>
                    </h4>
                    <h4>Bea Rp. <?= $this->CodeGenerator->rp($kasir2['bea']); ?>
                    </h4>
                </div>
                <div class="icon">
                    <i class="icon-like"></i>
        ...
        <div class="dashboard-stat2">
            <div class="display">
                <div class="number">
                    ...
                    <h4 class="font-green-sharp">Total Rp. <?= $this->CodeGenerator->rp($kasir3['total']); ?>
                    </h4>
                    <h4 class="font-red-haze">Penjualan Rp. <?= $this->CodeGenerator->rp($kasir3['transaksi']); ?>
                    </h4>
                    <h4>Bea Rp. <?= $this->CodeGenerator->rp($kasir3['bea']); ?>
                    </h4>
                </div>
                <div class="icon">
                    <i class="icon-like"></i>
