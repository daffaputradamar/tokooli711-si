...
<!-- BEGIN CORE PLUGINS -->
<!--[if lt IE 9]>
<script src="<?=base_url();?>/assets/global/plugins/respond.min.js">
</script>
<script src="<?=base_url();?>/assets/global/plugins/excanvas.min.js">
</script>
<![endif]-->
...
<script src="<?=base_url();?>assets/bootstrap-select.min.js" type="text/javascript"></script>
<!-- END CORE PLUGINS -->
